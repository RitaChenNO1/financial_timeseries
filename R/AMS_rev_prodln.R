...
pdq[1]
#with seasonal
rev.fit<-arima(ts_rev,order=c(3,1,0), seasonal=list(order=c(0,0,1), period=3))
...
write.table(fall, file = "C:/WORK/EGI/data/forecast_ams_cp_rev_prodln_6w.csv",quote = TRUE, sep = ",",row.names = FALSE)
